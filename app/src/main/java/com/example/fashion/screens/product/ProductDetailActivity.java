package com.example.fashion.screens.product;
...
import com.example.fashion.data.model.cart.Cart;
import com.example.fashion.data.model.product.Product;
import com.example.fashion.data.model.user.User;
import com.example.fashion.utils.AppUtils;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    ImageView image;
    TextView name, quantity, price, detail, btnminus, btnplus, tv_quantity;
    Button btn_addcart;
    ...
    private void loadInfo() {
        ...
        tv_quantity.setText("Số lượng tồn: " + product.getQuantity());
